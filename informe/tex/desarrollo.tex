...
\subsection{Tests}
	...
	\subsubsection{Diferencias en el tiempo de ejecuci\'on para reconocer d\'igitos}
		...
		Suponemos que el m\'etodo de la distancia al promedio de las componentes
		ser\'a el m\'as rapido. Pues cada vector de componentes de una imagen
		nueva debe ser comparada \'unicamente con $10$ vectores de componentes.
		En los otros dos m\'etodos se comparan con todos los vectores de componentes
		de la base de datos.
