...
plot "testKvecinos" using 1:2 title "1 Vecino" with linespoints ls 1,\
	"testKvecinos" using 1:3 title "5 Vecinos" with linespoints ls 2,\
	"testKvecinos" using 1:4 title "10 Vecinos" with linespoints ls 3,\
	"testKvecinos" using 1:5 title "30 Vecino" with linespoints ls 4,\
	"testKvecinos" using 1:6 title "50 Vecino" with linespoints ls 5,\
	"testKvecinos" using 1:7 title "100 Vecinos" with linespoints ls 6
